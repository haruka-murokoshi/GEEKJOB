 ...
 * @author user
 */
public class ｄｂ9 extends HttpServlet {
    Connection c=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
             try{
                 ...
                 String tel =request.getParameter("電話");
                 ...
                 ps = c.prepareStatement("insert into profiles values(?,?,?,?,?);");
                 ps.setInt(1,id);
                 ps.setString(2,name);
                 ps.setString(3,tel);
                 ps.setInt(4, age);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ｄｂ9</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ｄｂ9 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
