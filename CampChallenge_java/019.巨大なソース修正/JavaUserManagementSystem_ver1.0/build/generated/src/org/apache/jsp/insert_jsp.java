...
for (int i = 1; i <= 31; i++) {
      ...
      out.print(i);
      out.write('"');
if (udb != null && udb.getDay().equals(d)) {
      out.write("\n");
      out.write("                         ");
 ...
 if(udb != null &&(udb.getType() !=("")&&udb.getType().equals("1"))){
      out.write("checked =\"checked\"");
}
      out.write(">エンジニア<br>\n");
      out.write("               \n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"2\"");
if(udb != null &&(udb.getType() !=("")&&udb.getType().equals("2"))){
      out.write("checked =\"checked\"");
}
      out.write(">営業<br>        \n");
      out.write("               \n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\" ");
if(udb != null &&(udb.getType() !=("")&&udb.getType().equals("3"))){
      out.write("checked =\"checked\"");
}
      out.write(">その他<br><br>\n");
      out.write("         \n");
